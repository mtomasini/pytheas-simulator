...
class Map:
    ...
    def __init__(self, bounding_box: Tuple[float, float, float, float], earliest_time: pd.Timestamp, latest_time: pd.Timestamp,
        ...
        self.winds_data = self.save_dataset_winds(earliest_time, latest_time)
        self.currents_data = self.save_dataset_currents(earliest_time, latest_time)
        self.waves_data = self.save_dataset_waves(earliest_time, latest_time)
    ...
    def save_dataset_currents(self, earliest_time: pd.Timestamp, latest_time: pd.Timestamp):
    ...
    def save_dataset_winds(self, earliest_time: pd.Timestamp, latest_time: pd.Timestamp):
    ...
    def save_dataset_waves(self, earliest_time: pd.Timestamp, latest_time: pd.Timestamp):
